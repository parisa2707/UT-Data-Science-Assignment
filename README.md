...
Task 4: Add "Node Monitor" view to the right panel and "Error Log" view to the bottom right panel. Take a picture of your screen while these views are added in KNIME.
